...
export const SkeletonLine = styled.div<{ $width: string; $height?: string; $borderRadius?: string; $isDark?: boolean }>`
...
export const SkeletonBlock = styled.div<{ $width: string; $height?: string; $isDark?: boolean }>`
  ${({ $isDark }) => getSkeletonStyle($isDark)};
  background-color: #333D4C;
  width: ${({ $width }) => $width};
