  ...
  return (
    <StyledAgentCard aria-label="Loading Agent's information" aria-busy="true">
      <SimpleFlexContainer
        $alignItems="center"
        $gap="1.5rem"
        data-skeleton-name="agent-card-header"
      >
        <SkeletonCircle
          $isDark={isDark}
          $dim="80px"
          data-skeleton-name="agent-avatar"
        />
        <SimpleFlexContainer $direction="column">
          <SkeletonLine
            ...
            $height="28px"
            $isDark={isDark}
            data-skeleton-name="agent-name"
          />
          <SkeletonLine
            $width="90px"
            $height="22px"
            $isDark={isDark}
            data-skeleton-name="agent-title"
          />
        </SimpleFlexContainer>
      </SimpleFlexContainer>
      <SimpleFlexContainer
        $direction="column"
        data-skeleton-name="agent-contact-infortmation"
      >
      ...
      <SkeletonLine
        ...
        $height="48px"
        $isDark={isDark}
        data-skeleton-name="book-tour-CTA"
      />
    </StyledAgentCard>
  );
}
