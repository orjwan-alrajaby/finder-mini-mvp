...
import { StyledModalOverlay, StyledModal, StyledShowAllButton, StyledCloseModalBtn } from './styled';
...
export default function Modal({
    ...
    return (
        <DialogTrigger>
            ...
            <StyledModalOverlay isDismissable isOpen={isOpen} onOpenChange={setIsOpen}>
                <StyledModal>
                    <StyledCloseModalBtn className="close-modal-btn" onClick={() => setIsOpen(false)}>
                        <Image src="/icons/close-dark.svg" alt="" width={16} height={16} />
                    </StyledCloseModalBtn>
                    <EmblaCarousel slides={imageSlides} options={{ loop: true, startIndex: selectedImgIndex }}/>
                </StyledModal>
            </StyledModalOverlay>
        </DialogTrigger>
    )
