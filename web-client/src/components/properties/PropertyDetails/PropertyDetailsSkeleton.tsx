...
export function SkeletonMainInfoAndAbout({
  isDark = true,
      ...
      <SimpleFlexContainer $direction="column" $gap="1rem">
        <SimpleFlexContainer data-skeleton-name="property-tags">
          <SkeletonBlock
            $width="75px"
            $height="26px"
            data-skeleton-name="property-tag"
          />
          <SkeletonBlock
            $width="75px"
            $height="26px"
        ...
        <SkeletonLine
          ...
          $width="150px"
          $height="30px"
          data-skeleton-name="property-price"
        />
        <SkeletonLine
          $isDark={isDark}
          $width="228px"
          $height="21px"
          data-skeleton-name="property-address"
        />
        <SimpleFlexContainer data-skeleton-name="property-specs">
          ...
          <SkeletonLine
            ...
            $width="56px"
            $height="21px"
            data-skeleton-name="property-sqm"
          />
        </SimpleFlexContainer>
      </SimpleFlexContainer>
      <div>
        ...
        <SimpleFlexContainer
          $direction="column"
          data-skeleton-name="property-about-section-text"
        >
...
export function SkeletonGeneralInfoSection({
  isDark = true,
}: Readonly<{ isDark?: boolean }>) {
  return (
    <StyledGenInfoSection>
      ...
      <StyledTable>
        <tbody>
          {Array.from({ length: 5 }).map((_, i) => (
            <tr key={i}>
              <td>
                <SkeletonLine $isDark={isDark} $width="140px" $height="22px" />
              </td>
              <td>
                <SkeletonLine $isDark={isDark} $width="70px" $height="22px" />
              </td>
            </tr>
          ))}
        </tbody>
...
export function SkeletonAmenitiesSection({
  isDark = true,
}: Readonly<{ isDark?: boolean }>) {
  return (
    <div>
...
export function SkeletonLocationSection({
  isDark = true,
}: Readonly<{ isDark?: boolean }>) {
  return (
    <div>
...
export default function PropertyDetailsSkeleton() {
  return (
    <StyledMainContainer
      aria-label="Loading properties details page"
      aria-busy="true"
    >
      <SkeletonGallery />
      <StyledSection>
